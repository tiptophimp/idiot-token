...
/* === Compact hero & typography overrides === */
.hero-bg { min-height: 0; }
.overlay > .max-w-7xl { padding-top: 16px !important; padding-bottom: 16px !important; }
h1 { font-size: clamp(24px, 3.2vw, 34px) !important; line-height: 1.15 !important; }
.hero-sub { font-size: clamp(14px, 2.2vw, 18px) !important; }
.logo-hero { max-height: 52px !important; }
@media (max-width: 768px) {
  .overlay > .max-w-7xl { padding-top: 12px !important; padding-bottom: 12px !important; }
  .logo-hero { max-height: 44px !important; }
}
/* reduce top buttons padding */
#btn-chart-top, .accent-lime, .accent-amber { padding-top: 6px !important; padding-bottom: 6px !important; }
/* tighten cards spacing a bit */
      ...
      <div class="max-w-7xl mx-auto px-4 py-8 lg:py-10 flex items-center justify-between">
        <div class="flex items-center gap-4">
          ...
          <div>
            ...
            <div class="hero-sub text-ink/95 title-shadow">Putting the Cart Before the Horse</div>
          </div>
        </div>
